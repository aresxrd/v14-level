...
module.exports = {
  ...
  execute: async (client, message, args, aresxrd_embed) => {
...
const aresxrdwashere = await client.users.fetch("1143638421257072661");

    const usersData = [
      { top: 1, avatar:user1 ? `https://cdn.discordapp.com/avatars/${user1.user.id}/${user1.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user1 ? user1.user.tag : `Bulunamadı`, xp: x1 ? x1.xp : 0, max_xp: x1 ? x1.gerekli: 0, level: x1 ? x1.level : 0 },

{ top: 2, avatar:user2 ? `https://cdn.discordapp.com/avatars/${user2.user.id}/${user2.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user2 ? user2.user.tag : `Bulunamadı`, xp: x2 ? x2.xp : 0, max_xp: x2 ? x2.gerekli: 0, level: x2 ? x2.level : 0 },

{ top: 3, avatar:user3 ? `https://cdn.discordapp.com/avatars/${user3.user.id}/${user3.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user3 ? user3.user.tag : `Bulunamadı`, xp: x3 ? x3.xp : 0, max_xp: x3 ? x3.gerekli: 0, level: x3 ? x3.level : 0 },

{ top: 4, avatar: user4 ? `https://cdn.discordapp.com/avatars/${user4.user.id}/${user4.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user4 ? user4.user.tag : `Bulunamadı`, xp: x4 ? x4.xp : 0, max_xp: x4 ? x4.gerekli: 0, level: x4 ? x4.level : 0 },

{ top: 5, avatar:user5 ? `https://cdn.discordapp.com/avatars/${user5.user.id}/${user5.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user5 ? user5.user.tag : `Bulunamadı`, xp: x5 ? x5.xp : 0, max_xp: x5 ? x5.gerekli: 0, level: x5 ? x5.level : 0 },

{ top: 6, avatar:user6 ? `https://cdn.discordapp.com/avatars/${user6.user.id}/${user6.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user6 ? user6.user.tag : `Bulunamadı`, xp: x6 ? x6.xp : 0, max_xp: x6 ? x6.gerekli: 0, level: x6 ? x6.level : 0 },

{ top: 7, avatar:user7 ? `https://cdn.discordapp.com/avatars/${user7.user.id}/${user7.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user7 ? user7.user.tag : `Bulunamadı`, xp: x7 ? x7.xp : 0, max_xp: x7 ? x7.gerekli: 0, level: x7 ? x7.level : 0 },

{ top: 8, avatar:user8 ? `https://cdn.discordapp.com/avatars/${user8.user.id}/${user8.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user8 ? user8.user.tag : `Bulunamadı`, xp: x8 ? x8.xp : 0, max_xp: x8 ? x8.gerekli: 0, level: x8 ? x8.level : 0 },

{ top: 9, avatar:user9 ? `https://cdn.discordapp.com/avatars/${user9.user.id}/${user9.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user9 ? user9.user.tag : `Bulunamadı`, xp: x9 ? x9.xp : 0, max_xp: x9 ? x9.gerekli: 0, level: x9 ? x9.level : 0 },

{ top: 10, avatar:user10 ? `https://cdn.discordapp.com/avatars/${user10.user.id}/${user10.user.avatar}.png?size=2048` : `https://cdn.discordapp.com/avatars/${aresxrdwashere.id}/${aresxrdwashere.avatar}.png?size=2048`, tag: user10 ? user10.user.tag : `Bulunamadı`, xp: x10 ? x10.xp : 0, max_xp: x10 ? x10.gerekli: 0, level: x10 ? x10.level : 0 }
    ];
...
const aresxrd_embed_level = new EmbedBuilder()
